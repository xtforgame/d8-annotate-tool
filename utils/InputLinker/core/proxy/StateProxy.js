...
class StateProxyPropsProxy {
  constructor(type, link) {
    ...
    _defineProperty(this, "setValue", (value, rawArgs) => this.host.setState(prevState => this._getUpdatedState(prevState, this.link.name, value)));
...
exports.default = StateProxyPropsProxy;