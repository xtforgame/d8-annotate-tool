...
var _default = props => {
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_FormInputs.FormTimePicker, {
    label: t('timeStart'),
    value: lowerBound,
    onChange: onLowerBoundChange
  }), _react.default.createElement(_FormInputs.FormSpace, {
    variant: "content2"
  }), _react.default.createElement(_FormInputs.FormTimePicker, {
    label: t('timeEnd'),
    value: upperBound,
